...
class JobsetV1alpha2JobSetSpec(BaseModel):
    ...
    scale_policy: Optional[JobsetV1alpha2ScalePolicy] = Field(default=None, alias="scalePolicy")
    ...
    __properties: ClassVar[List[str]] = ["coordinator", "failurePolicy", "managedBy", "network", "replicatedJobs", "scalePolicy", "startupPolicy", "successPolicy", "suspend", "ttlSecondsAfterFinished"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of scale_policy
        if self.scale_policy:
            _dict['scalePolicy'] = self.scale_policy.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scalePolicy": JobsetV1alpha2ScalePolicy.from_dict(obj["scalePolicy"]) if obj.get("scalePolicy") is not None else None,
