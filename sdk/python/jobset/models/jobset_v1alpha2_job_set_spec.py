...
class JobsetV1alpha2JobSetSpec(BaseModel):
    ...
    job_cleanup_strategy: Optional[StrictStr] = Field(default=None, description="JobCleanupStrategy defines what to do with active jobs when the JobSet is finished. This applies to all possible conditions, i.e. Completed, Failed...", alias="jobCleanupStrategy")
    ...
    __properties: ClassVar[List[str]] = ["coordinator", "failurePolicy", "jobCleanupStrategy", "managedBy", "network", "replicatedJobs", "startupPolicy", "successPolicy", "suspend", "ttlSecondsAfterFinished"]
