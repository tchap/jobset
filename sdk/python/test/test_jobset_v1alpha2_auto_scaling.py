...
class TestJobsetV1alpha2AutoScaling(unittest.TestCase):
    """JobsetV1alpha2AutoScaling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobsetV1alpha2AutoScaling:
        """Test JobsetV1alpha2AutoScaling
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobsetV1alpha2AutoScaling`
        """
        model = JobsetV1alpha2AutoScaling()
        if include_optional:
            return JobsetV1alpha2AutoScaling(
                max_replicas = 56,
                metrics = [
    ...
    def testJobsetV1alpha2AutoScaling(self):
        """Test JobsetV1alpha2AutoScaling"""
