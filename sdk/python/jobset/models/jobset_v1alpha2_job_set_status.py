...
class JobsetV1alpha2JobSetStatus(BaseModel):
    ...
    terminal_state: Optional[StrictStr] = Field(default=None, description="TerminalState the state of the JobSet when it finishes execution. It can be Completed, Failed or Terminated. Otherwise, it is empty by default.", alias="terminalState")
