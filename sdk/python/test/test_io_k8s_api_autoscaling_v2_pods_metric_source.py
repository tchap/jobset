...
class TestIoK8sApiAutoscalingV2PodsMetricSource(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiAutoscalingV2PodsMetricSource:
        """Test IoK8sApiAutoscalingV2PodsMetricSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiAutoscalingV2PodsMetricSource`
        """
        model = IoK8sApiAutoscalingV2PodsMetricSource()
        if include_optional:
