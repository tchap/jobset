		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"jobCleanupStrategy": {
						SchemaProps: spec.SchemaProps{
							Description: "JobCleanupStrategy defines what to do with active jobs when the JobSet is finished. This applies to all possible conditions, i.e. Completed, Failed...",
							Type:        []string{"string"},
							Format:      "",
						},
					},
