...
class JobsetV1alpha2JobSetSpec(BaseModel):
    ...
    scale: Optional[JobsetV1alpha2Scale] = None
    ...
    __properties: ClassVar[List[str]] = ["coordinator", "failurePolicy", "managedBy", "network", "replicatedJobs", "scale", "startupPolicy", "successPolicy", "suspend", "ttlSecondsAfterFinished"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scale": JobsetV1alpha2Scale.from_dict(obj["scale"]) if obj.get("scale") is not None else None,
